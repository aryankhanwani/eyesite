      ...
      <section className="w-full py-12 md:py-16 lg:py-24 bg-[#faf9f6]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mt-8 md:mt-12">
              <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg border border-[#e7e8ea]/50">
                ...
                <h3 className="text-xl md:text-2xl font-semibold text-[#19395f] mb-3 md:mb-4">Comprehensive Health Check</h3>
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg border border-[#e7e8ea]/50">
                ...
                <h3 className="text-xl md:text-2xl font-semibold text-[#19395f] mb-3 md:mb-4">Personalised Care</h3>
                <p className="text-sm md:text-base text-black/70 leading-relaxed">
          ...
          <div className="mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50 text-center">
                ...
                <h3 className="font-semibold text-[#19395f] mb-2 text-sm md:text-base">NHS Examinations</h3>
                <p className="text-xs md:text-sm text-black/60">Available for eligible patients</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50 text-center">
                ...
                <h3 className="font-semibold text-[#19395f] mb-2 text-sm md:text-base">Private Examinations</h3>
                <p className="text-xs md:text-sm text-black/60">Comprehensive private eye care</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50 text-center">
                ...
                <h3 className="font-semibold text-[#19395f] mb-2 text-sm md:text-base">Smart Employee Vouchers</h3>
                <p className="text-xs md:text-sm text-black/60">Accepted and stockists</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50 text-center">
                ...
                <h3 className="font-semibold text-[#19395f] mb-2 text-sm md:text-base">EyeMed Vouchers</h3>
                <p className="text-xs md:text-sm text-black/60">Accepted and stockists</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-12 shadow-lg border border-[#e7e8ea]/50 mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-1 md:mb-2 text-sm md:text-base">Early Detection</h3>
                  <p className="text-sm md:text-base text-black/70">Many eye conditions show no symptoms until they've progressed. Regular exams help catch issues early.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 md:gap-4">
                <div className="flex-shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-full bg-[#19395f] flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-1 md:mb-2 text-sm md:text-base">Overall Health</h3>
                  <p className="text-sm md:text-base text-black/70">Eye exams can detect signs of diabetes, high blood pressure, and other systemic conditions.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 md:gap-4">
                <div className="flex-shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-full bg-[#19395f] flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-1 md:mb-2 text-sm md:text-base">Optimal Vision</h3>
                  <p className="text-sm md:text-base text-black/70">Ensure your prescription is up-to-date for the clearest, most comfortable vision possible.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 md:gap-4">
                <div className="flex-shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-full bg-[#19395f] flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-1 md:mb-2 text-sm md:text-base">Preventive Care</h3>
                  <p className="text-sm md:text-base text-black/70">Regular monitoring helps prevent vision loss and maintain eye health throughout your life.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50">
                ...
                <h3 className="font-semibold text-[#19395f] mb-2 md:mb-3 text-center text-sm md:text-base">Initial Assessment</h3>
                <p className="text-xs md:text-sm text-black/70 text-center">Discussion of your medical history, symptoms, and visual needs.</p>
              </div>
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50">
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#19395f]/10 flex items-center justify-center mx-auto mb-3 md:mb-4">
                  <span className="text-xl md:text-2xl font-bold text-[#19395f]">2</span>
                </div>
                <h3 className="font-semibold text-[#19395f] mb-2 md:mb-3 text-center text-sm md:text-base">Visual Testing</h3>
                <p className="text-xs md:text-sm text-black/70 text-center">Comprehensive vision tests to determine your prescription needs.</p>
              </div>
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50">
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#19395f]/10 flex items-center justify-center mx-auto mb-3 md:mb-4">
                  <span className="text-xl md:text-2xl font-bold text-[#19395f]">3</span>
                </div>
                <h3 className="font-semibold text-[#19395f] mb-2 md:mb-3 text-center text-sm md:text-base">Health Screening</h3>
                <p className="text-xs md:text-sm text-black/70 text-center">Detailed examination of eye structures and health assessment.</p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-4 md:gap-6 mt-6 md:mt-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 text-center">
                  <h3 className="font-semibold text-base md:text-lg mb-2">Adults (18-60)</h3>
                  <p className="text-sm md:text-base text-white/90">Every 2 years, or annually if you wear glasses or contacts</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 text-center">
                  <h3 className="font-semibold text-base md:text-lg mb-2">Seniors (60+)</h3>
                  <p className="text-sm md:text-base text-white/90">Annual examinations recommended for early detection</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 text-center">
                  <h3 className="font-semibold text-base md:text-lg mb-2">Children</h3>
                  <p className="text-sm md:text-base text-white/90">First exam at 6 months, then as recommended by your optometrist</p>
                </div>
              </div>
            </div>
          </div>
