      ...
      <section className="w-full py-12 md:py-16 lg:py-24 bg-[#faf9f6]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg border border-[#e7e8ea]/50">
                ...
                <h3 className="text-xl md:text-2xl font-semibold text-[#19395f] mb-3 md:mb-4">Expert Styling Consultation</h3>
          ...
          <div className="bg-gradient-to-br from-[#19395f] to-[#0d2440] rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-12 text-white mb-12 md:mb-16 lg:mb-20">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-medium mb-4 md:mb-6">UVEX Safety Glasses</h2>
              ...
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-base md:text-lg mb-1">Professional Protection</h3>
                  <p className="text-sm md:text-base text-white/80">Expert fitting and comprehensive range available</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50">
                <h3 className="font-semibold text-[#19395f] mb-2 md:mb-3 text-sm md:text-base">Thin & Lightweight</h3>
                <p className="text-xs md:text-sm text-black/70">High-index lenses for thinner, lighter glasses even with strong prescriptions.</p>
              </div>
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50">
            ...
            <div>
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start gap-2 md:gap-3">
                  ...
                  <p className="text-sm md:text-base text-black/70">Face shape analysis to find the most flattering frames</p>
                </div>
                <div className="flex items-start gap-2 md:gap-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-[#19395f] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 md:w-4 md:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-sm md:text-base text-black/70">Lifestyle considerations for work, sports, and daily activities</p>
                </div>
                <div className="flex items-start gap-2 md:gap-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-[#19395f] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 md:w-4 md:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50 text-center">
                ...
                <h3 className="font-semibold text-[#19395f] mb-2 text-sm md:text-base">Designer Collections</h3>
                <p className="text-xs md:text-sm text-black/70">Exclusive frames from world-renowned designers</p>
              </div>
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50 text-center">
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#19395f]/10 flex items-center justify-center mx-auto mb-3 md:mb-4">
                  <svg className="w-6 h-6 md:w-8 md:h-8 text-[#19395f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="font-semibold text-[#19395f] mb-2 text-sm md:text-base">Quality Materials</h3>
                <p className="text-xs md:text-sm text-black/70">Premium acetate, titanium, and lightweight materials</p>
              </div>
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md border border-[#e7e8ea]/50 text-center">
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#19395f]/10 flex items-center justify-center mx-auto mb-3 md:mb-4">
                  <svg className="w-6 h-6 md:w-8 md:h-8 text-[#19395f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="font-semibold text-[#19395f] mb-2 text-sm md:text-base">Latest Styles</h3>
                <p className="text-xs md:text-sm text-black/70">Regularly updated collections with the newest trends</p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center gap-2 md:gap-3 p-3 md:p-4 bg-[#f4f6f8] rounded-xl">
                  ...
                  <div>
                    <h3 className="font-semibold text-black text-sm md:text-base">Progressive Lenses</h3>
                    <p className="text-xs md:text-sm text-black/60">Seamless vision correction for all distances</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 md:gap-3 p-3 md:p-4 bg-[#f4f6f8] rounded-xl">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-[#19395f]/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-black text-sm md:text-base">Photochromic Lenses</h3>
                    <p className="text-xs md:text-sm text-black/60">Adaptive lenses that darken in sunlight</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 md:gap-3 p-3 md:p-4 bg-[#f4f6f8] rounded-xl">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-[#19395f]/10 flex items-center justify-center flex-shrink-0">
          ...
          <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-12 shadow-lg border border-[#e7e8ea]/50 mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-1 md:mb-2 text-sm md:text-base">Exclusive Designer Brands</h3>
                  <p className="text-sm md:text-base text-black/70">Premium frames from leading international designers and brands.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 md:gap-4">
                <div className="flex-shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-full bg-[#19395f] flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-1 md:mb-2 text-sm md:text-base">Perfect Fit Guarantee</h3>
                  <p className="text-sm md:text-base text-black/70">Expert fitting ensures your glasses are comfortable and properly adjusted.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 md:gap-4">
                <div className="flex-shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-full bg-[#19395f] flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-1 md:mb-2 text-sm md:text-base">Comprehensive Aftercare</h3>
                  <p className="text-sm md:text-base text-black/70">Free adjustments and ongoing support to keep your glasses in perfect condition.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 md:gap-4">
                <div className="flex-shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-full bg-[#19395f] flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-1 md:mb-2 text-sm md:text-base">Wide Range of Styles</h3>
                  <p className="text-sm md:text-base text-black/70">From classic to contemporary, find frames that match your personality.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-4 md:gap-6 mt-6 md:mt-8">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 text-center">
                  ...
                  <p className="text-white/90 text-xs md:text-sm">Store in a protective case when not in use</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 text-center">
                  <h3 className="font-semibold text-base md:text-lg mb-2">Free Adjustments</h3>
                  <p className="text-white/90 text-xs md:text-sm">Visit us anytime for free adjustments and repairs</p>
                </div>
              </div>
            </div>
          </div>
